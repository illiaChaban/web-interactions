  ...
  return (
    <>
      ...
      <ul class="flex flex-col gap-4 ">
        {transitions.map(
          ({ name, forwardTransition, backwardTransition }, i) => {
              ...
              <li>
                <A
                  ...
                  onClick={overrideLinkClick(() => {
                    viewTransition(forwardTransition, () =>
                      navigate(href, { state: { backwardTransition } })
                    );
                  })}
                >
...
const transitions = [
  {
    name: "Slide-in",
    forwardTransition: "slide-in",
    backwardTransition: "slide-out",
  },
  {
    name: "Slide-in-2",
    forwardTransition: "slide-in-2",
    backwardTransition: "slide-out-2",
  },
] as const;
